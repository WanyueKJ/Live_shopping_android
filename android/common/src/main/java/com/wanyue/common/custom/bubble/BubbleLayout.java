package com.wanyue.common.custom.bubble;
...
public class BubbleLayout extends FrameLayout
{
    ...
    {
        mLook = Look.getType(a.getInt(R.styleable.BubbleLayout2_lookAt, Look.BOTTOM.value));
        mLookPosition = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_lookPosition, 0);
        mLookWidth = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_lookWidth, Util.dpToPx(getContext(), 17F));
        mLookLength = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_lookLength, Util.dpToPx(getContext(), 17F));
        mShadowRadius = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_shadowRadius, Util.dpToPx(getContext(), 3.3F));
        mShadowX = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_shadowX, Util.dpToPx(getContext(), 1F));
        mShadowY = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_shadowY, Util.dpToPx(getContext(), 1F));
        mBubbleRadius = a.getDimensionPixelOffset(R.styleable.BubbleLayout_bubbleRadius, Util.dpToPx(getContext(), 7F));
        mBubblePadding = a.getDimensionPixelOffset(R.styleable.BubbleLayout2_bubblePadding, Util.dpToPx(getContext(), 8));
        mShadowColor = a.getColor(R.styleable.BubbleLayout2_shadowColor, Color.GRAY);
        mBubbleColor = a.getColor(R.styleable.BubbleLayout2_bubbleColor, Color.WHITE);
        a.recycle();
    }
