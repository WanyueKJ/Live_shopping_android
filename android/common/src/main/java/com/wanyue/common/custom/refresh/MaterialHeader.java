...
public class MaterialHeader extends InternalAbstract implements RefreshHeader {
    ...
    public MaterialHeader(Context context, AttributeSet attrs) {
        ...
        thisView.setMinimumHeight(DpUtil.dp2px(100));

        mProgress = new MaterialProgressDrawable(this);
//        mProgress.setBackgroundColor(CIRCLE_BG_LIGHT);
//        mProgress.setAlpha(255);

        int progressColor=ResourceUtil.getColor(context,R.color.global);
        mProgress.setColorSchemeColors(progressColor,0xffff4444,0xff669900,0xffaa66cc,0xffff8800);
